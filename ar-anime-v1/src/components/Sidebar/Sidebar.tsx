...
const Sidebar = (props: Props) => {
  return (
    <header className="w-full md:w-[calc(100%-48px)] lg:w-24 h-14 md:h-[72px] lg:h-[calc(100%-64px)] p-4 md:p-6 bg-semiDarkBlue flex lg:flex-col justify-between items-center md:rounded-[10px] lg:rounded-[20px] fixed top-0 md:top-8 z-10">
